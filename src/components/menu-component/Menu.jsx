...
const Menu = () => {
  return (
    <div className="min-h-[calc(100vh_-_80px)] w-[80px] lg:w-[150px] py-5 px-2 fixed border-r ">
      <div className="w-full flex flex-col gap-1">
        <Button className="bg-transparent hover:bg-transparent group h-auto flex-col text-gray-700">
          ...
          <span className="group-hover:text-cyan-500 hidden lg:inline">Explorer</span>
        </Button>
        <Button className="bg-transparent hover:bg-transparent group h-auto flex-col text-gray-700">
          <svg
          ...
          <span className="group-hover:text-cyan-500 hidden lg:inline">Mes Photos</span>
        </Button>
        <Button className="bg-transparent hover:bg-transparent group h-auto flex-col text-gray-700">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="group-hover:text-cyan-500 hidden lg:inline">Favories</span>
        </Button>
        ...
        <Button className="bg-transparent hover:bg-transparent group h-auto flex-col text-gray-700">
          ...
          <span className="group-hover:text-cyan-500 hidden lg:inline">Upload</span>
        </Button>
      </div>
    </div>
  );
