...
const MenuDesktop = () => {
  ...
  return (
    <div className="min-h-[calc(100vh_-_80px)] w-[150px] py-5 fixed border-r">
      <div className="w-full flex flex-col gap-1">
        <Link href={"/"}>
          <Button
            className={`${
              params === "/"
                ? "text-cyan-950 border-r-4 border-cyan-950"
                : "text-cyan-600"
            } rounded-none w-full bg-transparent hover:bg-transparent group h-auto flex-col `}
          >
            <svg
        ...
        <Link href={"/upload"}>
          ...
          >
            ...
            <span className="group-hover:text-cyan-950 font-bold">Upload</span>
          </Button>
        </Link>
      </div>
    </div>
